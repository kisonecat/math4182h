...
\begin{inspiration}
``A function is differentiable at a point if, when you zoom in far enough,
it cannot help but look linear.'' \\
\byline{(A useful lie, until you make it precise.)}
\end{inspiration}
...
How does this definition depend on the \emph{choice of parameterization} of the line through $a$ in direction $v$?
\end{problem}
