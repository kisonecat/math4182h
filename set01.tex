...
\begin{problem}\label{gradient-definition}%
...
\begin{problem}\label{dot-product-derivative}%
...
\begin{problem}\label{derivative-of-determinant}%
Recall that for
\(
...
\end{cases}
\]
For nonzero $v \in \R^2$, compute the directional derivative $D_v g(0,0)$.
\end{problem}
...
\begin{problem}\label{cauchy-riemann-equations}%
...
\begin{problem}\label{gateaux-derivative-podasip}%
