...
\begin{problem}
  Recall \ref{derivative-of-determinant}. For a $2\times 2$ matrix $H$, expand $\det(I+H)$ as a Taylor series.
\end{problem}
...
\begin{problem}
Find the third-order Taylor polynomial (i.e., with terms of total degree $\le 3$) of
\[
...
\begin{problem}
  ...
  Specifically, suppose $f:\R^2\to\R$ is $C^2$ in a neighborhood of $(0,0)$, and assume $\nabla f(0,0)=\vec{0}$.
  Assume the determinant of the Hessian of $f$ at $(0,0)$ is positive, and assume that
